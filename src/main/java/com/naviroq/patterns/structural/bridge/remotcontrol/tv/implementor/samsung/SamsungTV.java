package com.naviroq.patterns.structural.bridge.remotcontrol.tv.implementor.samsung;
...
public class SamsungTV implements TV {
    @Override
    public void turnOn() {
        System.out.println("[SamsungTV] Powering on.");
    }
    ...
    @Override
    public void mute() {
        System.out.println("[SamsungTV] Tv is Muted.");
    }

    @Override
    public void autoScan() {
        System.out.println();
        System.out.println("[SamsungTV] Performing Scanning.");
    ...
    @Override
    public void standBy() {
        System.out.println("[SamsungTV] Switching to standby mode on.");
    }

    @Override
    public void setChannel(int channel) {
        System.out.println("[SamsungTV] Switching to channel " + channel);
    }
